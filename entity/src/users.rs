use std::{error::Error, num::NonZeroUsize, sync::RwLock};
...
static USERS_CACHE: Lazy<RwLock<LruCache<String, User>>> =
    Lazy::new(|| RwLock::new(LruCache::new(NonZeroUsize::new(10).unwrap())));
